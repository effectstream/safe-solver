...
const getTotalUniqueMainWalletsIR: any = {"usedParamSet":{},"params":[],"statement":"SELECT COUNT(DISTINCT delegated_to)::int AS total\nFROM score_entries"};
