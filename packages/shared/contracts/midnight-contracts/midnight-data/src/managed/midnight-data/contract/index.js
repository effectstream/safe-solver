...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      storeValue: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`storeValue: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const _payload_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('storeValue',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(_payload_0),
        ...
        const result_0 = this._storeValue_0(context,
                                            partialProofData,
                                            _payload_0);
    ...
    this.impureCircuits = { storeValue: this.circuits.storeValue };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('storeValue', new __compactRuntime.ContractOperation());
  ...
  _storeValue_0(context, partialProofData, _payload_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(_payload_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
